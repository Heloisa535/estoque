...
public class CadastrarEletronico {
	...
	public static void newCadastrarEletronico() {
		...
		while (quantidadeErro == false) {
			...
			System.out.println("Digite a quantidade de eletrônicos que irá comprar: ");
		...
		String dadoE = "Eletrônico: "+nome+" | Descrição: "+descricao+" | Código de Barras: "+codigo+" | Quantidade: "+quantidade+" | Preço: "+preco+" | Marca: "+marca+" | Modelo: "+modelo;
